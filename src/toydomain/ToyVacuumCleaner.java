 ...
 * @author santi
 */
public class ToyVacuumCleaner extends PhysicalObject {

    public ToyVacuumCleaner(Shape s, double x, double y, double a) {
        position.x = x;
        position.y = y;
        angle = a;
        shape = s;
    ...
    public ToyVacuumCleaner(Element e) {
    ...
    public Object clone() {
        return new ToyVacuumCleaner(shape,position.x,position.y, angle);
    }
