...
//        a = new ToyStraightLineAgent();
//        a = new ToyStraightRandomAgent();
//        a = new ToyFixedSequenceAgent();
        a = new ToyInternalStateAgent();

        Perception p = new ToyPerception();

        State s = new State(new SAXBuilder().build("maps/toy-3x1.xml").getRootElement());
