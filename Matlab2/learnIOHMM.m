% Example:
% [a,b] = learnIOHMM(['traces-forcefourraydistance/trace-m0-ForceStraightLineAgent.txt';'traces-forcefourraydistance/trace-m1-ForceStraightLineAgent.txt'], 10,4,10,2)

function [bnet,engine] = learnIOHMM(traces,EMIterations,STATES,XSIZE,YSIZE,filename)
%function [bnet,engine] = learnIOHMM(traces,EMIterations,STATES,XSIZE,YSIZE)
...
dumpDBN(bnet,filename,[2,CSIZE,XSIZE,1]);
