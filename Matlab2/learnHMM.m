% Example:
% [a,b] = learnHMM(['traces-forcefourraydistance/trace-m0-ForceStraightLineAgent.txt';'traces-forcefourraydistance/trace-m1-ForceStraightLineAgent.txt'], 10,4,10,2)

function [bnet,engine] = learnHMM(traces,EMIterations,STATES,XSIZE,YSIZE,filename)
%function [bnet,engine] = learnHMM(traces,EMIterations,STATES,XSIZE,YSIZE)
